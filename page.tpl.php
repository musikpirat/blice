...
<body class="<?php print $classes; ?>">
  ...
  <div id="page-wrapper"><div id="page" data-role="page">

    <div id="header" data-role="header"><div class="section clearfix">
      <?php print $header; ?>
    </div></div> <!-- /.section, /#header -->

    <div id="main-wrapper"><div id="main" class="clearfix<?php if ($primary_links || $navigation) { print ' with-navigation'; } ?>">

      <div id="content" class="column" data-role="content"><div class="section">
    ...
    <?php if ($footer || $footer_message || $secondary_links): ?>
      <div id="footer" data-role="footer"><div class="section">
